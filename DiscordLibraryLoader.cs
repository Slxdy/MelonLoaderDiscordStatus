...
public static class DiscordLibraryLoader
{
    ...
    public const string LibPath64 = "DiscordStatus.Dependencies.x86_64.discord_game_sdk.dll";
    ...
    public static void LoadLibrary()
    {
        ...
        if (!File.Exists(LibDestinationPath))
        {
            ...
            using (var libStr = Melon<DiscordStatusPlugin>.Instance.MelonAssembly.Assembly.GetManifestResourceStream(MelonUtils.IsGame32Bit() ? LibPath86 : LibPath64))
            {
                if (libStr == null)
        ...
        Melon<DiscordStatusPlugin>.Logger.Msg("Discord Library loaded.");
        Loaded = true;
    }
